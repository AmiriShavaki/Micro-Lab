...
_Code:
	.DB  0xFF,0xFF,0xFF,0xFF,0xFF,0xF7,0xE3,0xD5
	.DB  0xF7,0xF7,0xFF,0xFF,0xFF,0xFF,0xFF
...
_main:
; .FSTART _main
; 0000 001D unsigned char Col,Scan,Refresh,Index,S;
; 0000 001E DDRC=0xFF;
;	Col -> R17
;	Scan -> R16
;	Refresh -> R19
